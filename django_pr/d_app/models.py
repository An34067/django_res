...
class Employees(models.Model):
    first_name = models.CharField(verbose_name='Имя сотрудника', max_length=40)
    surname = models.CharField('Фамилия сотрудника', max_length=40)
...
class Orders(models.Model):
    ...
    customer = models.ForeignKey(Costomers, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Клиент')
...
class OrderItems(models.Model):
    ...
    dish = models.ForeignKey('Menu', on_delete=models.PROTECT, verbose_name='Блюдо')
...
#     table = models.ForeignKey('Tables', on_delete=models.PROTECT, verbose_name='Столик')
#     employee = models.ForeignKey(Employees, on_delete=models.PROTECT, verbose_name='Сотрудник')
#     customer = models.ForeignKey(Customers, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='Клиент')
#     order_date = models.DateTimeField('Дата заказа')
#     status = models.CharField('Статус', max_length=15, choices=STATUS_CHOICES, default='pending')
#     total_amount = models.DecimalField('Общая сумма', max_digits=10, decimal_places=2, default=0)
#     notes = models.TextField('Примечания', blank=True)
